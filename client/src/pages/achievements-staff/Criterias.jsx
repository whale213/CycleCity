...
export default function Criterias() {
  ...
  const searchCriterias = () => {
    http.get(`/criteria?search=${search}`).then((res) => {
      setCriteriaList(res.data);
    });
  };
  ...
  const deleteCriteria = () => {
    http.delete(`/criteria/${idToDelete}`).then((res) => {
                  ...
                  <tbody class="divide-y divide-thistle dark:divide-fedora">
                    {criteriaList.map((criteria, id) => (
                      <tr
                        ...
                        onClick={() => {
                          navigate(
                            `/staff/achievements/EditCriterias/${criteria.criteriaId}`
                          );
                        }}
                      >
                        ...
                        <td class="px-8 py-2 whitespace-nowrap">
                          <div
                            onClick={(event) => {
                              ...
                              setIdToDelete(criteria.criteriaId);
                              setNameToDelete(criteria.name);
                              setOpen(true);
                            }}
