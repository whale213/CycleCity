...
function Post({ post }) {
  ...
  return (
    <div className="flex bg-ultraViolet shadow-lg rounded-lg mx-4 md:mx-auto my-56 max-w-md md:max-w-2xl min-w-[98%]">
      <div className="flex items-start px-4 py-6">
        ...
        <div className="">
          <div className="flex items-center justify-between">
            ...
            >
              <h2 className="text-lg font-semibold text-seashell -mt-1">
          ...
          <p className="text-seashell">{post.createdAt}</p>
          <p className="mt-3 text-seashell text-sm min-w-full">
...
// <div className="block p-6 rounded-lg shadow-lg bg-gray-100 ml-auto mr-auto w-200">
//     <div className="w-200">
//         <div className="flex justify-between mb-4 align-bottom">
//         <img
//             src="post.user_post_desc.profileImage"
//             alt=""
//             className="w-10 h-10 rounded-lg object-cover m-3"
//         />
//         <a
//             href="#!"
//             className="font-medium text-purple-600 hover:text-purple-700 focus:text-purple-800 duration-300 transition ease-in-out text-sm m-3"
//         >
//             {post.user_post_desc.name}
//         </a>
//         <a
...
//         <div className="flex items-center gap-3 cursor-pointer text-xs">
...
//         <div className="w-200">
//             <div className="flex justify-between mb-4 align-bottom">
//                 <img src="post.user_post_desc.profileImage" alt="" className = "w-10 h-10 rounded-lg object-cover m-3"/>
//                 <a href="#!" className="font-medium text-purple-600 hover:text-purple-700 focus:text-purple-800 duration-300 transition ease-in-out text-sm m-3">{post.user_post_desc.name}</a>
//                 <a href="#!" className="font-medium text-purple-600 hover:text-purple-700 focus:text-purple-800 duration-300 transition ease-in-out text-sm m-3">{post.createdAt}</a>
//             </div>
//             <p className="text-gray-700 mb-6">{post.caption}</p>
//             <img src = "post.post" alt="" className = "w-full max-h-96 object-cover mt-5"/>
...
// <div className = "shadow-xs bg-slate-300 rounded-md overflow-x-auto" >
//     <div className = "p-5">
//         <div className = "flex items-center justify-between relative" >
//             <div className = "flex gap-5">
//                 <img src="post.user_post_desc.profileImage" alt="" className = "w-10 h-10 rounded-lg object-cover"/>
//                 <div className = "flex flex-col">
//                     <Link to = {`/profile/${post.user_post_desc.userId}`} className = "no-underline text-inherit">
//                         <span className = "font-medium">{post.user_post_desc.name}</span>
