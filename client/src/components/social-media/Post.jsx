...
function Post({post}) {
  ...
  return (
        <div class="flex bg-white shadow-lg rounded-lg mx-4 md:mx-auto my-56 max-w-md md:max-w-2xl min-w-[98%]" >
            <div class="flex items-start px-4 py-6">
                {/* <img class="w-12 h-12 rounded-full object-cover mr-4 shadow" src="https://images.unsplash.com/photo-1542156822-6924d1a71ace?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="avatar"/>*/}
                <img src="post.user_post_desc.profileImage" alt= "" />
                <div class="">
                    <div class="flex items-center justify-between">
                        <h2 class="text-lg font-semibold text-gray-900 -mt-1">{post.user_post_desc.name}</h2>
                        <p>{post.postID}</p>
                    </div>
                    <p class="text-gray-700">{post.createdAt}</p>
                    <p class="mt-3 text-gray-700 text-sm min-w-full">
                        <a href={`http://localhost:5173/user/comments/${post.postID}`}>{post.caption}</a>
                    </p>
                    <img src= "https://images.unsplash.com/photo-1542156822-6924d1a71ace?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt=""  class = "rounded-md mx-auto" />
                    <img src= "" alt="" />
                    ...
                    {post.user_post_desc.userId === 2 && (
                        <div
                            ...
                            className="hover:bg-orange-200 dark:hover:bg-fedora dark:hover:bg-opacity-70 hover:text-warning dark:text-grey dark:hover:text-warning rounded-md p-2 max-w-fit"
                        >
                            <RiDeleteBin6Line
                            size={20}
                            className="visible"
