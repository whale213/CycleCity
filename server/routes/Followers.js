...
router.get("/:id", async (req, res) => {
    try {
        ...
        let followers = await Followers.findAll({
          ...
          include: { model: User, as: "followeduserID_desc", attributes: ['userId', 'name', 'bio']}
        })
...
router.get("/myfollowers/:id", async (req, res) => {
    try {
        // Fetch all users from the database
        let id = req.params.id;
        ...
        let followers = await Followers.findAll({
          ...
          include: { model: User, as: "followeruserID_desc", attributes: ['userId', 'name', 'bio']}
        })
